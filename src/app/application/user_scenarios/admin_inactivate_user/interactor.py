...
from app.application.user_scenarios.admin_inactivate_user.payload import (
...
class InactivateUserInteractor(
    ...
    def __init__(
        ...
        committer: Committer,
        all_sessions_deleter: GlobalLogoutService,
    ):
        self._authorization_service = authorization_service
        self._user_data_gateway = user_data_gateway
        self._user_service = user_service
        self._committer = committer
        self._all_sessions_deleter = all_sessions_deleter
    ...
    async def __call__(
        ...
        await self._all_sessions_deleter.remove_all_user_access(user.id_)
